...
def run_one_layer_deep_conv_rf_shared(data, choosen_classes, fraction_of_train_samples):
    (train_images, train_labels), (test_images, test_labels) = get_subset_data(
        data, choosen_classes, fraction_of_train_samples)

    # Train
    # ConvRF (layer 1)
    conv1 = DeepConvRFShared(kernel_size=10, stride=2)
...
def run_two_layer_deep_conv_rf_shared(data, choosen_classes, fraction_of_train_samples):
    (train_images, train_labels), (test_images, test_labels) = get_subset_data(
        data, choosen_classes, fraction_of_train_samples)
    ...
    # ConvRF (layer 2)
    conv2 = DeepConvRFShared(kernel_size=7, stride=1)
