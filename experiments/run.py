...
parser.add_argument("--min_samples", type=int, default=135)
parser.add_argument("--max_samples", type=int, default=13542)
...
parser.add_argument("--classes", nargs='+', type=int, default=[3, 8])
