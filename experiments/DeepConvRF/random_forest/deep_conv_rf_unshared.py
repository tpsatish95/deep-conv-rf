...
def run_one_layer_deep_conv_rf_unshared(data, choosen_classes, fraction_of_train_samples):
...
def run_two_layer_deep_conv_rf_unshared(data, choosen_classes, fraction_of_train_samples):
    (train_images, train_labels), (test_images, test_labels) = get_subset_data(
        data, choosen_classes, fraction_of_train_samples)
